...
public class packagePayment extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					String price=null;
					String hotel=null;
					packagePayment frame = new packagePayment(Username,price,hotel);
	 ...
	 * @param hotel 
	 */
	public packagePayment(String Username, String totalprice, String Package) {
		...
		JLabel lblNewLabel_3 = new JLabel("Packge Name:-");
		lblNewLabel_3.setForeground(Color.BLACK);
		lblNewLabel_3.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblNewLabel_3.setBounds(499, 283, 116, 26);
		contentPane.add(lblNewLabel_3);
		
		JLabel Package_name = new JLabel("New label");
		Package_name.setForeground(Color.BLACK);
		Package_name.setFont(new Font("Tahoma", Font.BOLD, 15));
		Package_name.setBounds(626, 285, 185, 26);
		contentPane.add(Package_name);
			...
			public void actionPerformed(ActionEvent e) {
                ...
                else if(ExpireDate.getText().matches("[0-9]{2}[ ]{1}[0-9]{2}[ ]{1}[0-9]{4}")==false)
                {
	                ...
	                try {
	                    ...
	                    String query = "INSERT INTO paymentpackage values('" + Username_1.getText()+ "','" + CardNumber.getText() + "','" + CVC.getText() + "','" +
